...
import { BottomSheetScrollView } from "@gorhom/bottom-sheet"; // <-- ADD THIS IMPORT
      ...
      <Card variant="primary" marginBottom="md">
        ...
        {[
          ...
          <TouchableOpacity
            key={style}
            onPress={() =>
              updateDietaryPreferences({ dietaryStyle: style as any })
            }
          >
            <Box
              padding="sm"
        ...
        <Box flexDirection="row" gap="sm">
          {(["mild", "medium", "hot", "fire"] as const).map((level) => (
            <TouchableOpacity
              key={level}
              onPress={() =>
                updateDietaryPreferences({ spiceTolerance: level })
              }
              style={{ flex: 1 }}
            >
              <Box
      ...
      <Card variant="secondary" marginBottom="md">
            ...
            <Box flexDirection="row" flexWrap="wrap" gap="xs">
              {profile.allergies.map((allergy, index) => (
                <Box
                  ...
                  alignItems="center"
                >
                  <Text fontSize={14} marginRight="xs">
                    ⚠️
                  </Text>
                  <Text
                    variant="body"
        ...
        >
          <Text variant="body" fontSize={13} color="secondaryText">
            💡 To update your safety information, you'll need to contact support
            or reset your profile preferences. This ensures your safety is
            always protected.
          </Text>
        </Box>
      </Card>
      <Card variant="primary" marginBottom="md">
        ...
        <Box flexDirection="row" flexWrap="wrap" gap="xs">
          {[
            ...
            const isSelected =
              preferences?.dietary.healthObjectives.includes(key) || false;
            return (
              <TouchableOpacity
                key={key}
                onPress={() => {
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() => {
                  const currentObjectives =
                    preferences?.dietary.healthObjectives || [];
                  const newObjectives = currentObjectives.filter(
                    (o) => o !== customObjective
                  );
                  updateDietaryPreferences({
                    healthObjectives: newObjectives,
        ...
        {(
          ...
          >
            <Box
              ...
              marginBottom="xs"
              backgroundColor={
                preferences.cookingContext.typicalCookingTime === key
                  ? "primary"
                  : "surface"
              }
              borderRadius="md"
        ...
        {(
          ...
          >
            <Box
              ...
              marginBottom="xs"
              backgroundColor={
                preferences.cookingContext.budgetLevel === key
                  ? "primary"
                  : "surface"
              }
              borderRadius="md"
        ...
        <Box flexDirection="row" gap="sm">
          {[1, 2, 4, 6].map((servings) => (
            <TouchableOpacity
              key={servings}
              onPress={() =>
                updateCookingContext({ typicalServings: servings })
              }
              style={{ flex: 1 }}
            >
              <Box
                padding="sm"
                backgroundColor={
                  preferences.cookingContext.typicalServings === servings
                    ? "primary"
                    : "surface"
                }
                borderRadius="md"
  ...
  const renderKitchenCapabilities = () => (
    <Box padding="lg">
      ...
      <Card variant="primary" marginBottom="md">
        ...
        <Box flexDirection="row" flexWrap="wrap" gap="xs">
          {[
            ...
            const isSelected =
              preferences?.kitchenCapabilities.appliances.specialty.includes(
                key
              ) || false;
            return (
              <TouchableOpacity
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() => {
                  const currentAppliances =
                    preferences?.kitchenCapabilities.appliances.specialty || [];
                  const newAppliances = currentAppliances.filter(
                    (a) => a !== customAppliance
                  );
                  updateKitchenCapabilities({
                    appliances: {
      ...
      <Card variant="primary" marginBottom="md">
        ...
        <Text variant="body" marginBottom="xs" fontWeight="600">
          Refrigerator
        </Text>
          ...
          {(["small", "medium", "large"] as const).map((size) => (
            ...
            >
              <Box
                padding="sm"
                backgroundColor={
                  preferences?.kitchenCapabilities.storageSpace.refrigerator ===
                  size
                    ? "primary"
                    : "surface"
                }
          ...
          {(["small", "medium", "large"] as const).map((size) => (
            ...
            >
              <Box
                padding="sm"
                backgroundColor={
                  preferences?.kitchenCapabilities.storageSpace.freezer === size
                    ? "primary"
                    : "surface"
                }
                borderRadius="md"
              ...
              >
                <Text
                  variant="body"
                  color={
                    preferences?.kitchenCapabilities.storageSpace.freezer ===
                    size
                      ? "primaryButtonText"
                      : "primaryText"
                  }
          ...
          {(["minimal", "moderate", "extensive"] as const).map((size) => (
            ...
            >
              <Box
                padding="sm"
                backgroundColor={
                  preferences?.kitchenCapabilities.storageSpace.pantry === size
                    ? "primary"
                    : "surface"
                }
                borderRadius="md"
              ...
              >
                <Text
                  variant="body"
                  color={
                    preferences?.kitchenCapabilities.storageSpace.pantry ===
                    size
                      ? "primaryButtonText"
                      : "primaryText"
                  }
        ...
        {[
          ...
          const currentLevel =
            preferences?.kitchenCapabilities?.techniqueComfort?.[
              key as keyof typeof preferences.kitchenCapabilities.techniqueComfort
            ] || 1;
          return (
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() => {
                  const currentCuisines =
                    preferences?.cookingStyles.preferredCuisines || [];
                  const newCuisines = currentCuisines.filter(
                    (c) => c !== customCuisine
                  );
                  updateCookingStyles({
                    preferredCuisines: newCuisines,
              ...
              <Button
                ...
                onPress={() => {
                  if (customCuisineInput.trim()) {
                    const currentCuisines =
                      preferences?.cookingStyles.preferredCuisines || [];
                    const customCuisine = customCuisineInput
                      .trim()
                      .toLowerCase();
      ...
      <Card variant="primary" marginBottom="md">
        ...
        <Box flexDirection="row" flexWrap="wrap" gap="xs">
          {[
            ...
            const isSelected =
              preferences?.cookingStyles.cookingMoods.includes(key) || false;
            return (
              <TouchableOpacity
                key={key}
                onPress={() => {
                  const currentMoods =
                    preferences?.cookingStyles.cookingMoods || [];
      ...
      <Card variant="primary" marginBottom="md">
        ...
        <Box flexDirection="row" flexWrap="wrap" gap="xs">
          {[
            ...
            const isSelected =
              preferences?.cookingStyles.favoriteIngredients.includes(key) ||
              false;
            return (
              <TouchableOpacity
                key={key}
      ...
      <Card variant="primary" marginBottom="md">
        ...
        <Box flexDirection="row" flexWrap="wrap" gap="xs">
          {[
            ...
            const isSelected =
              preferences?.cookingStyles.avoidedIngredients.includes(key) ||
              false;
            return (
              <TouchableOpacity
                key={key}
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() => {
                  const currentAvoided =
                    preferences?.cookingStyles.avoidedIngredients || [];
                  const newAvoided = currentAvoided.filter(
                    (i) => i !== customIngredient
                  );
                  updateCookingStyles({
                    avoidedIngredients: newAvoided,
