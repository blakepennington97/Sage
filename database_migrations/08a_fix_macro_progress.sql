-- Fix for get_daily_macro_progress function
-- This fixes the column reference error in the JOIN condition
...
BEGIN
  ...
  SELECT 
    ...
    up.daily_calorie_goal::INTEGER as goal_calories,
...
-- Comment
COMMENT ON FUNCTION get_daily_macro_progress IS 'Calculate daily macro progress against user goals - FIXED VERSION';